...
import 'package:keema_app/Video_Screen.dart';
...
class _CourseVideoState extends State<CourseVideo> {
  ...
  _initChannel() async {
    Channel channel = await APIService.instance
          .fetchChannel(channelId: 'UClgCwi2LxL6fB81piVoEqJQ');
        setState(() {
          _channel = channel;
        });
  }
  _buildVideo(Video video){
      return GestureDetector(
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => VideoScreen(id: video.id,title: video.title))),
          child: Container(
 ...
 _channel.videos = allVideos;   
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:  AppBar(
        title:  Text('Keema Youtube Channel'),
